...
# Source library.sh
source $HOME/.config/yannick/library.sh

# -----------------------------------------------------
# Check to use wallpaper cache
# -----------------------------------------------------

if [ -f ~/.config/yannick/settings/wallpaper_cache ]; then
    use_cache=1
...
blurfile="$HOME/.config/yannick/settings/blur.sh"
defaultwallpaper="$HOME/.config/yannick/wallpapers/default.jpg"
wallpapereffect="$HOME/.config/yannick/settings/wallpaper-effect.sh"
blur="50x30"
blur=$(cat $blurfile)
